...
public class LKNKPSPublicSoap12
{
    interface LKNIWcfMethod
    {
        LKNExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(LKNExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public LKNKPSPublicSoap12(){}

    public LKNKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public LKNKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected LKNExtendedSoapSerializationEnvelope createEnvelope()
    {
        LKNExtendedSoapSerializationEnvelope envelope= new LKNExtendedSoapSerializationEnvelope(LKNExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,LKNExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,LKNExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new LKNIWcfMethod()
        {
            @Override
            public LKNExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                LKNExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(LKNExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(LKNIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        LKNExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,LKNExtendedSoapSerializationEnvelope envelope)
    {
