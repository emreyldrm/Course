...
class LKNSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class LKNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LKNDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new LKNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LKNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LKNDateTimeConverter dateTimeConverter = new LKNStandardDateTimeConverter();

    public LKNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LKNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LKNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LKNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LKNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LKNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
