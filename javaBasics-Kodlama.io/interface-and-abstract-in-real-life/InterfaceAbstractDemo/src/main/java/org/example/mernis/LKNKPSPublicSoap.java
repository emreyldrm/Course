...
public class LKNKPSPublicSoap
{
    ...
    public LKNKPSPublicSoap(){}

    public LKNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LKNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LKNExtendedSoapSerializationEnvelope envelope= new LKNExtendedSoapSerializationEnvelope(LKNExtendedSoapSerializationEnvelope.VER11);
